...
ramka_szczczegoly_obiektu=Frame(root)

ramka_lista_uzytkownikow.grid(row=0, column=0, padx=50)
ramka_formularz.grid(row=0, column=1)
ramka_szczczegoly_obiektu.grid(row=1, column=0,columnspan=2, padx=50, pady=20)
...
label_opis_obiektu=Label(ramka_szczczegoly_obiektu, text='Szczegóły obiektu')
label_imie_szczegoly=Label(ramka_szczczegoly_obiektu, text='Imię:')
label_imie_szczegoly_wartosc=Label(ramka_szczczegoly_obiektu, text='...', width=10)
label_nazwisko_szczegoly=Label(ramka_szczczegoly_obiektu, text='Nazwisko:')
label_nazwisko_szczegoly_wartosc=Label(ramka_szczczegoly_obiektu, text='...', width=10)
label_posty_szczegoly=Label(ramka_szczczegoly_obiektu, text='Posty:')
label_posty_szczegoly_wartosc=Label(ramka_szczczegoly_obiektu, text='...', width=10)
label_miejscowosc_szczegoly=Label(ramka_szczczegoly_obiektu, text='Miejscowość:')
label_miejscowosc_szczegoly_wartosc=Label(ramka_szczczegoly_obiektu, text='...',width=10)
...
map_widget=tkintermapview.TkinterMapView(ramka_szczczegoly_obiektu,width=700,height=300)
